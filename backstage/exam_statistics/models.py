...
class Exam(models.Model):
    ...
    class_s = models.ForeignKey(CustomUserClass, verbose_name="班级", on_delete=models.CASCADE, **NULL_BLANK_TRUE)
...
class Grade(models.Model):
    ...
    exam = models.ForeignKey(Exam, verbose_name="考试", related_name="Grades", on_delete=models.CASCADE)
