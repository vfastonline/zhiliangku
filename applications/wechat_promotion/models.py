...
class WechatBrowse(models.Model):
	...
	photo2 = models.ImageField('第1页照片', upload_to="wechat/photo", storage=ImageStorage(), blank=True, help_text="活动照")
	photo3 = models.ImageField('第2页照片', upload_to="wechat/photo", storage=ImageStorage(), blank=True, help_text="活动照")
	photo4 = models.ImageField('第3页照片', upload_to="wechat/photo", storage=ImageStorage(), blank=True, help_text="活动照")
	photo5 = models.ImageField('第4页照片', upload_to="wechat/photo", storage=ImageStorage(), blank=True, help_text="活动照")
