...
class ResumeDelete(View):
	...
	def post(self, request, *args, **kwargs):
		...
		try:
			...
			resume_type = param_dict.get("resume_type", "")  # 简历类型
			pk_id = str_to_int(param_dict.get("pk_id", 0))  # 简历子信息ID
...
class ResumeUpdate(View):
	...
	def post(self, request, *args, **kwargs):
		...
		try:
			...
			career_objective_id = resume_info_dict.get("career_objective_id", 0)  # 求职意向ID
