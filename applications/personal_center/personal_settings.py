...
class AccountBindWeiXin(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        token = ""
        try:
            # https://open.weixin.qq.com/connect/qrconnect?appid=wx7c9efe7b17c8aef2&redirect_uri=http%3a%2f%2fwww.zhiliangku.com%2fpersonal_center%2fpersonal_settings%2faccountbind%2fweixin&response_type=code&scope=snsapi_login&state=L2FkbWlu#wechat_redirect
