...
urlpatterns = [
    ...
    url('^personal_settings/accountbind/qq$', personal_settings.AccountBindQQ.as_view()),
    url('^personal_settings/accountbind/weixin$', personal_settings.AccountBindWeiXin.as_view()),
