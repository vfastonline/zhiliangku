...
class Project(models.Model):
    ...
    technology = models.ForeignKey(Technology, verbose_name="技术分类", blank=True, null=True, on_delete=models.CASCADE)
...
class Course(models.Model):
    ...
    lecturer = models.ForeignKey(CustomUser, verbose_name='讲师', related_name='Course_custom_user',
                                 limit_choices_to={'role': 1}, blank=True, null=True, on_delete=models.CASCADE)
...
class UnlockVideo(models.Model):
    ...
    custom_user = models.ForeignKey(CustomUser, verbose_name='学生', related_name='UnlockVideoCustomUser',
                                    limit_choices_to={'role': 0}, blank=True, null=True, on_delete=models.CASCADE)
