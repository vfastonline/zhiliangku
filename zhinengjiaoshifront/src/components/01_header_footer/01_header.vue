<template>
  <header class="mw project_header hc">
    <div class="fl">
      ...
      <span class="dib nav_tag"><a href="/tracks/project/list/index.html"> <span class="font1_22_3"> 项目</span> </a></span>
    ...
    <!--<div class="fr">-->
    <!--<span class="font1_20_3">登录</span>-->
    <!--<span class="font1_20_3"> / </span>-->
    <!--<span class="font1_20_3">注册</span>-->
    <!--</div>-->
    <div class="fr aaa">
