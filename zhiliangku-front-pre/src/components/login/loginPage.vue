<template>
  <div class="loginpage-continer incenter">
    ...
    <div class="fontcenter loginpage-forget">
      <span class="font14pr23b8ff pointer " @click="forgetPassword">忘记密码？</span>
    </div>
    <div class="fontcenter">
      <span class="other-login font145A646E">其他方式登录：</span>
      <a :href="qqBase64Url">
        <img class="longinpage-bottom-icons pointer" src="../../assets/img/icons/QQ.svg" alt="">
      </a>
      <a :href="wxBase64Url">
        <img class="longinpage-bottom-icons pointer" src="../../assets/img/icons/wechat.svg" alt="">
      </a>
    </div>
  </div>
</template>
