    ...
    <div class="country_container hc">
      <div class="country">
        <img class="country_flag"
             :src="$myConst.httpUrl+ main_data.country_a_flag"
             alt="">
      ...
      <div class="country">
        <img class="country_flag"
             :src="$myConst.httpUrl+main_data.country_b_flag"
             alt="">
    ...
    <div class="resault_state hc">
      <div class="r country ">
        <mt-button class="button_state"
                   @click="active_button('A')"
                   :class="{'active_button':main_data.match_results=='A'}"
                   type="default">胜</mt-button>
        <span v-if="main_data.match_results=='A'"
              class="stake_num ftc a">
          <num :main_data="{value:main_data.integral}"></num>
        </span>
      </div>
      <div class="r country ">
        <mt-button class="button_state"
                   @click="active_button('C')"
                   :class="{'active_button':main_data.match_results=='C'}"
                   type="default">平</mt-button>
        <span v-if="main_data.match_results=='C'"
              class="stake_num ftc a">
          <num :main_data="{value:main_data.integral}"></num>
        </span>
      </div>
      <div class=" country r">
        <mt-button class="button_state"
                   ...
                   type="default">胜</mt-button>
        <span v-if="main_data.match_results=='B'"
              class="stake_num ftc a">
          <num :main_data="{value:main_data.integral}"></num>
        </span>
      </div>
