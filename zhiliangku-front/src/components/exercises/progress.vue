<template>
  <div class="mainwidth incenter progress-container">
    <div class="mainwidth progress-bar">
        ...
        <span v-for="(item,index) in mainData" :key="index" @click="mainfun(index)" 
        class="progress-dot pointer zindex10"
        :class="item.className"
        ><img v-if="item.className=='right-selected'" src="../../assets/img/icons/选择题/小圆点_已答对.svg" alt=""><img v-if="item.className=='wrong-selected'" src="../../assets/img/icons/选择题/小圆点_已答错.svg" alt=""></span>
