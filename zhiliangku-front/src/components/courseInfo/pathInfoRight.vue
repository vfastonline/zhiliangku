<template>
  <div class="path-info-right">
    ...
    <div class="pir-main-content">
      <ul>
        <li v-for="(lidata,indexli) in mainData.pathstages" :key="indexli" class="tli tli1 relative clearfix ofhid">
          <div class="pirm-dote  zindex100 pirm-dot-border-grey" :class="{
            'pirm-dote-solid-green':indexli<indexli1,
            'pirm-dote-border-green':indexli==indexli1
            }">
          </div>
          <div class="pirm-line-top  zindex10 pirm-line-grey" v-if="indexli" :class="{
          'pirm-line-green':indexli<=indexli1+1,
          }">
          </div>
          <div class="pirm-line  zindex1 pirm-line-grey" :class="{'pirm-line-start':indexli==0,
