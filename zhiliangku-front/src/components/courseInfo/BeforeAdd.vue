  ...
  <div class="beforeAdd">
    ...
    <div class="ba-main mainwidth incenter clearfix">
      ...
      <div class="floatr ba-progress">
        ...
        <div class="bap-all">
          <el-collapse accordion @change="jj" >
            <el-collapse-item 
            v-for="(item,index) in allData.sections" :key="index"
            :name="item.id"
            >
              <template slot="title">
                <img class="beforeadd-img-icons" v-if="activeId==item.id" src="../../assets/img/icons/path+路线+课程_图标/课程详情_收起.svg" alt="">
              ...
              <div  class="bap-container clearfix">
                <ul  class="incenter floatr bapc-videos">
                  ...
                  v-for="(thisli,liindex) in allData.container[index].data"  :key="liindex"  class="bacp-v-li rise clearfix">
                    ...
                    <div class="left">
                      <img src="../../assets/img/icons/path+路线+课程_图标/课程详情_录播.svg" alt="">
                    </div>
                    <div class="right">
  ...
  export default {
    ...
    methods: {
      jj(id) {
        ...
        this.$get('/tracks/video/list/info?section_id='+id).then(res=>{
