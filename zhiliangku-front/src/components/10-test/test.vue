<template>
  <div class="mainwidth incenter">
    <el-dialog title="成绩" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
    ...
    <div class="test_container incenter">
      ...
      <div>
        <iframe src="http://118.190.209.153:7681/" onload="" frameborder="0" width="1088px" height="400" scrolling='no' hspace="0"
          vspace="0"></iframe>
      </div>
