    ...
    <div v-if="show" class="mrpc-additional-list">
      ...
      <ul>
        <li v-for="(item,index) in otherData.claim_list" :key="index" class="marginbottom24 textellipsis">
          <img v-if="item.checked==false" class="mrpc-conform" src="./img/勾选框_空选.svg" alt="">
          <img v-if="item.checked==true" class="mrpc-conform textellipsis" src="./img/勾选框_选中.svg" alt="">
