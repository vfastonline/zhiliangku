  ...
  <div class="header_container">
    <header class="mw project_header hc r ">
      <div class=" header_font">
        <a href="/backstage/index/"><img class="logo dib vm"
                         src="./img/智量酷-logo-slogan.png"
                         alt=""></a>
        <span class="dib nav_tag">
        <a href="/exam/statistics/">
          <span class="font1_22_3" :class="{font1_22_f:active_class('/exam/statistics/')}"> 考核</span>
        </a>
      </span>
        <!--<span class="dib nav_tag"><a href="#"> <span class="font1_22_3"> 考核</span> </a></span>-->
        <span class="dib nav_tag">
        <a href="/employment/leaderboard/list/">
          <span class="font1_22_3">内容</span>
        </a>
      </span>
        <span class="dib nav_tag">
        <a href="/community/faq/list/">
          <span class="font1_22_3"> 问答</span>
        </a>
      </span>
        <span class="dib">
        <a href="/community/faq/list/">
          <span class="font1_22_3"> 学员</span>
        </a>
      </span>
      </div>
      <div>
