  ...
  <div class="lvs-container">
    <div class="lvs-content clearfix inmiddle mainwidth">
      <div id="e8888b74d1229efec6b4712e17cb6b7a_e" class="lvsc-video floatl">
        <img :src="imgUrl" alt="">
        <el-button class="lvsc-enterButton" :style="myButtonStyle" >进入直播间</el-button>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        liveData:[],
        imgUrl:'',
        myButtonStyle:{'color':"#ffffff",'height':'44px','width':'164px',
        'border-radius':'22px','background-color':'#23B8FF'}
      };
    },
    methods:{
      changeImg(item){
    ...
    created(){
      this.$ajax.get('lives/index/list').then(res=>{
