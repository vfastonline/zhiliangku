    ...
    <el-dialog @close="modalClose()" :show-close="false" :visible.sync="centerDialogVisible">
      ...
      <el-form v-show="allshow.loginActive" :model="ruleForm1" status-icon :rules="rules2" ref="myform1">
        ...
        <div class="marginbottom24 fc">
          <span class="letterspace1 font2_14_3 pointer" @click="changeModal('getPasswordActive')">忘密码了</span>
        </div>
        <div class="clearfix">
      ...
      <el-form v-show="allshow.logupActive" :model="ruleForm2" status-icon :rules="rules2" ref="myform2">
        ...
        <el-form-item label="6-16位密码（区分大小写）" prop="pass">
          <el-input @keyup.enter.native="submitForm('myform2','logupType',ruleForm2,changeModal,'verifyEmailActive')" type="password" v-model="ruleForm2.pass" auto-complete="off"></el-input>
        </el-form-item>
