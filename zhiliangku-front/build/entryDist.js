...
const entry = {
  ...
  // },
  // exam_statistics: {
  //   path: 'b02_exam_statistics',
  //   filename: 'exam/statistics/index.html'
  // },
  exam_add: {
    path: 'b03_exam_add',
    filename: 'exam/add/index.html'
  },
  // exam_detail: {
  //   path: 'b04_exam_detail',
  //   filename: 'exam/detail/index.html'
  // },
  // exam_report: {
  //   path: 'b05_exam_report',
  //   filename: 'exam/report/index.html'
  // }
}
...
Object
  ...
  .forEach(el => {
    ...
    //注意此处可以填充一些插件或者js，比如babel-polyfill但是本项目中用到了大量flex，
    // ie不支持flex所就不用兼容ie9而加入babel-polyfill了
